...
public class InvokeSearch {
	...
	private void addTarget(Class<?> class1, String targetPackageName, String classSuffix) {
		...
		if (packageName.length() > targetPackageName.length() 
	...
	private void addTarget(Class<?> class1, Method method, String targetPackageName, String classSuffix, 
			String call, String path, Map<String, InvokeTarget> invokeTargets) {
