...
public class DatabaseControlDao extends AbstractDao {
    ...
    public void dropAllTable() {
        ...
        sqls[18] = "DROP TABLE IF EXISTS USER_NOTIFICATIONS CASCADE;";
        sqls[19] = "DROP TABLE IF EXISTS PROVISIONAL_REGISTRATIONS CASCADE;";
        sqls[20] = "DROP TABLE IF EXISTS USER_ROLES CASCADE;";
        sqls[21] = "DROP TABLE IF EXISTS ROLES CASCADE;";
        sqls[22] = "DROP TABLE IF EXISTS USER_CONFIGS CASCADE;";
        sqls[23] = "DROP TABLE IF EXISTS READ_MARKS CASCADE;";
        sqls[24] = "DROP TABLE IF EXISTS SYSTEMS CASCADE;";
        sqls[25] = "DROP TABLE IF EXISTS USERS CASCADE;";
        for (String sql : sqls) {
            LOG.debug(sql);
            executeUpdate(sql);
        }
    ...
    public void dropAllData() {
        ...
        sqls[18] = "TRUNCATE TABLE USER_NOTIFICATIONS;";
        sqls[19] = "TRUNCATE TABLE PROVISIONAL_REGISTRATIONS;";
        sqls[20] = "TRUNCATE TABLE USER_ROLES;";
        sqls[21] = "TRUNCATE TABLE ROLES;";
        sqls[22] = "TRUNCATE TABLE USER_CONFIGS;";
        sqls[23] = "TRUNCATE TABLE READ_MARKS;";
        sqls[24] = "TRUNCATE TABLE SYSTEMS;";
        sqls[25] = "TRUNCATE TABLE USERS;";
        for (String sql : sqls) {
            LOG.debug(sql);
            executeUpdate(sql);
        }
