...
public class LdapConfigsEntity extends GenLdapConfigsEntity {
	...
	public boolean isLdapLoginAble() {
		if (getAuthType().intValue() == LdapConfigsEntity.AUTH_TYPE_LDAP
			|| getAuthType().intValue() == LdapConfigsEntity.AUTH_TYPE_BOTH
			|| getAuthType().intValue() == LdapConfigsEntity.AUTH_TYPE_LDAP_2
			|| getAuthType().intValue() == LdapConfigsEntity.AUTH_TYPE_BOTH_2) {
			return true;
		}
		return false;
	}
